...
#define FIFO_OFFSET_SIZE             (0x100)  /* SHMDS_HUB_0104_11 add */
...
int32_t hostif_write_proc(uint8_t adr, const uint8_t *data, uint16_t size)
{
    ...
    uint8_t *send_data;  /* SHMDS_HUB_0104_11 mod */
...
/* SHMDS_HUB_0104_11 add S */
    send_data = kzalloc(512+128, GFP_KERNEL);
    if (send_data == NULL){
        pr_err("shub-spi_write: kzalloc error\n");
        return -ENOMEM;
    }
/* SHMDS_HUB_0104_11 add E */
    ...
    kfree(send_data);  /* SHMDS_HUB_0104_11 add */
    return ret;
}
...
/* SHMDS_HUB_0347_01 mod S */
    ...
    uint8_t *r_buff;  /* SHMDS_HUB_0104_11 mod */
...
/* SHMDS_HUB_0104_11 add S */
    r_buff = kzalloc(FIFO_OFFSET_SIZE+FIFO_SIZE+2, GFP_KERNEL);
    if (r_buff == NULL){
        pr_err("shub-spi_read: kzalloc error\n");
        return -ENOMEM;
    }
/* SHMDS_HUB_0104_11 add E */
    ...
    txbuf_p = &r_buff[0];
    //rxbuf_p = &r_buff[1];
    rxbuf_p = &r_buff[FIFO_OFFSET_SIZE];  /* SHMDS_HUB_0104_11 mod */
...
/* SHMDS_HUB_0347_01 add E */
    ...
    kfree(r_buff);  /* SHMDS_HUB_0104_11 add */
    return ret;
}
