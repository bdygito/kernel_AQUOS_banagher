...
#define SHUB_DIAG_START_GYRO        _IOR(SHUBIO,1045, struct IoctlDiagRes)
#define SHUB_DIAG_START_ACC         _IOR(SHUBIO,1046, struct IoctlDiagRes)
#define SHUB_DIAG_START_BARO        _IOR(SHUBIO,1047, struct IoctlDiagRes)
#define SHUB_DIAG_START_MAG         _IOR(SHUBIO,1048, struct IoctlDiagRes)
