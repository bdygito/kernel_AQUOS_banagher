...
s32 bbm_com_ac_callback_register(ulong userdata,
		s32 (*callback)(ulong userdata, u8 bufid, u8 *data, s32 length))
{
	fc8350_ac_user_data = userdata;
	fc8350_ac_callback = callback;
...
{
	fc8350_ac_user_data = 0;
	fc8350_ac_callback = NULL;
...
void bbm_com_check_tsb(HANDLE handle, DEVICEID devid, u8 *dm_data)
{
	fc8350_check_tsb(handle, devid, dm_data);
}
