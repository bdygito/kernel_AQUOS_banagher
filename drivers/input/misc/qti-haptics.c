...
struct work_struct haptics_call_chain_start_work;
struct work_struct haptics_call_chain_stop_work;
...
void blocking_notifier_call_chain_start_work(struct work_struct *work)
{
                blocking_notifier_call_chain(&qpnp_hap_notifier_list, QPNP_HAP_VIB_START, NULL);
}

void blocking_notifier_call_chain_stop_work(struct work_struct *work)
{
...
#if defined( CONFIG_SHUB_ML630Q790 )
//		blocking_notifier_call_chain(&qpnp_hap_notifier_list, QPNP_HAP_VIB_START, NULL);
		schedule_work(&haptics_call_chain_start_work);
#endif /* CONFIG_SHUB_ML630Q790 */
#ifdef CONFIG_SHARP_SHTERM
...
#if defined( CONFIG_SHUB_ML630Q790 )
//		blocking_notifier_call_chain(&qpnp_hap_notifier_list, QPNP_HAP_VIB_STOP, NULL);
		schedule_work(&haptics_call_chain_stop_work);
#endif /* CONFIG_SHUB_ML630Q790 */
	}
#endif /* CONFIG_INPUT_QTI_SHARP_HAPTICS */
...
#ifdef CONFIG_INPUT_QTI_SHARP_HAPTICS
#if defined( CONFIG_SHUB_ML630Q790 )
INIT_WORK(&haptics_call_chain_start_work, blocking_notifier_call_chain_start_work);
INIT_WORK(&haptics_call_chain_stop_work, blocking_notifier_call_chain_stop_work);
#endif /* CONFIG_SHUB_ML630Q790 */
#endif /* CONFIG_INPUT_QTI_SHARP_HAPTICS */
	return 0;
