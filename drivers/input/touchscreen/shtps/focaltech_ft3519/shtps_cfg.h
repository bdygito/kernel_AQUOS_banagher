...
#if 0 /** For build test */
	#undef CONFIG_SHARP_TPS_FOCALTECH_FT3519

	#define CONFIG_SHARP_TPS_FOCALTECH_FT3519
#endif

#include <linux/input/shtps_dev.h>
/* --------------------------------------------------------------------------- */
#if defined(CONFIG_SHARP_TPS_FOCALTECH_FT3519)
	#include "ft3519/shtps_cfg_ft3519.h"
