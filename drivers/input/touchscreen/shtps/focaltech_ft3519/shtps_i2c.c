...
static int shtps_i2c_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
	...
	#if defined(SHTPS_PANEL_KIND_DETECT_ENABLE)
		result = shtps_touchpanel_module_get_panel_kind();
#if 1	//test
		ERR_PRINTK("shtps_touchpanel_kind = %d\n", result);
#endif	//test
...
#endif	// test
		if(result != SH_BOOT_TOUCHPANEL_KIND_FT3519) {
