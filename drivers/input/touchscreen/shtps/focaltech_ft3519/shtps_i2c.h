...
#define M_WRITE_PACKET_FUNC(A, B, C, D) \
	(A)->devctrl_func_p->packet_write_f((A)->tps_ctrl_p, B, C, D)
...
#define M_DIRECT_READ_FUNC(A, B, C, D, E) \
	(A)->devctrl_func_p->direct_read_f((A)->tps_ctrl_p, B, C, D, E)
