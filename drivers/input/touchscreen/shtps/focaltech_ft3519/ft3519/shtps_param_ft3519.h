...
#ifndef __SHTPS_PARAM_FT3519_H__
#define __SHTPS_PARAM_FT3519_H__
...
/* -----------------------------------------------------------------------------------
 */
#define SHTPS_REGVAL_STATUS_CRC_ERROR 0xEF
...
/* -----------------------------------------------------------------------------------
 */
#if defined(CONFIG_SHTPS_FOCALTECH_FACETOUCH_DETECT) || \
    defined(CONFIG_SHTPS_FOCALTECH_FACETOUCH_OFF_DETECT)
 ...
 */
	...
	SHTPS_PARAM_DEF(SHTPS_CTRL_FW_REPORT_RATE_STFLIB_KEVT_NORMAL,
	                SHTPS_DEF_STFLIB_KEVT_SCANRATE_MODE_NORMAL);
	SHTPS_PARAM_DEF(SHTPS_CTRL_FW_REPORT_RATE_STFLIB_KEVT_HIGH,
	                SHTPS_DEF_STFLIB_KEVT_SCANRATE_MODE_HIGH);
	SHTPS_PARAM_DEF(SHTPS_CTRL_FW_REPORT_RATE_STFLIB_KEVT_LCD_BRIGHT_LOW,
	                SHTPS_DEF_STFLIB_KEVT_SCANRATE_MODE_NORMAL);
 ...
 */
	...
	SHTPS_PARAM_DEF(SHTPS_PRM_REJECT_ABANDONED_TOUCH_MALFUNCTIONS_ENABLE, 1);
	SHTPS_PARAM_DEF(SHTPS_PRM_REJECT_ABANDONED_TOUCH_MALFUNCTIONS_THRESH_Y_MIN, 0);
	SHTPS_PARAM_DEF(SHTPS_PRM_REJECT_ABANDONED_TOUCH_MALFUNCTIONS_THRESH_Y_MAX, 600);
	SHTPS_PARAM_DEF(SHTPS_PRM_REJECT_ABANDONED_TOUCH_MALFUNCTIONS_THRESH_W_MIN, 0);
	SHTPS_PARAM_DEF(SHTPS_PRM_REJECT_ABANDONED_TOUCH_MALFUNCTIONS_THRESH_W_MAX, 7);
	SHTPS_PARAM_DEF(SHTPS_PRM_REJECT_ABANDONED_TOUCH_MALFUNCTIONS_THRESH_TIME_MS, 10);
#endif /* SHTPS_REJECT_ABANDONED_TOUCH_MALFUNCTIONS_ENABLE */

/* -----------------------------------------------------------------------------------
 */
#if defined(SHTPS_FTB_DELAYED_START_ENABLE)
	SHTPS_PARAM_DEF(SHTPS_FTB_START_DELAY, 2000);
#endif /* SHTPS_FTB_DELAYED_START_ENABLE */

/* -----------------------------------------------------------------------------------
 */
#endif /* __SHTPS_PARAM_FT3519_H__ */
