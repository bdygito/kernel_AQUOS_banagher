...
#ifndef __SHTPS_CFG_FT8707_H__
#define __SHTPS_CFG_FT8707_H__
...
#define SHTPS_GET_HW_VERSION_RET_UNKNOWN 0xFF
	...
	#include "ft8707/shtps_fw_ft8707_es1.h"
	#include "ft8707/shtps_fw_ft8707.h"
	...
	static const shtps_multi_fw_info_t SHTPS_MULTI_FW_INFO_TBL[] = {
	    {SHTPS_GET_HW_VERSION_RET_ES_0, tps_fw_data_es1, SHTPS_FWSIZE_NEWER_ES1, SHTPS_FWVER_NEWER_ES1,
	     "ES1"},
	    {SHTPS_GET_HW_VERSION_RET_ES_1, tps_fw_data_es1, SHTPS_FWSIZE_NEWER_ES1, SHTPS_FWVER_NEWER_ES1,
	     "ES1"},
	    {SHTPS_GET_HW_VERSION_RET_ES_1_5, tps_fw_data_es1, SHTPS_FWSIZE_NEWER_ES1,
	     SHTPS_FWVER_NEWER_ES1, "ES1"},
	    ...
	    {SHTPS_GET_HW_VERSION_RET_UNKNOWN, tps_fw_data, SHTPS_FWSIZE_NEWER, SHTPS_FWVER_NEWER,
	     "NORMAL"},
	};
...
#define CONFIG_SHTPS_FOCALTECH_LCD_SIZE_Y 2280
...
#define SHTPS_MODULE_VENDOR_DETECT_ENABLE
