...
#define F54_QUERY_RECEIVERELECTRODECOUNT(data)			data[0]
#define F54_QUERY_TRANSMITTERELECTRODECOUNT(data)		data[1]
...
#define F54_QUERY_TOUCHCONTROLLERFAMILY(data)			data[5]
#define F54_QUERY_HASPIXELTOUCHTHRESHOLDTUNING(data)	(data[6] & 0x01)
#define F54_QUERY_HASSENSORASSIGNMENT(data)				(data[7] & 0x01)
...
#define F54_QUERY_RSVD(data)							((data[7] >> 4) & 0x01)
...
#define F54_QUERY_CURVECOMPENSATIONMODE(data)			(data[8] & 0x03)
#define F54_QUERY_HASIIRFILTER(data)					((data[9] >> 1) & 0x01)
#define F54_QUERY_HASCMNREMOVAL(data)					((data[9] >> 2) & 0x01)
#define F54_QUERY_HASCMNMAXIMUM(data)					((data[9] >> 3) & 0x01)
...
#define F54_QUERY_HASMMSTATEMACHINE(data)				((data[10] >> 1) & 0x01)
#define F54_QUERY_HASSIGNALCLARITY(data)				((data[10] >> 2) & 0x01)
#define F54_QUERY_HASBURSTSPANMETRIC(data)				((data[10] >> 3) & 0x01)
...
struct rmi_map {
	...
	u8			fn12_ctrl22_disable_settings[1];
		...
		u8		reg_fn54_ctrl113_TX_thermal_update_interval_def[2];
		u8		reg_fn54_ctrl113_RX_thermal_update_interval_def[2];
