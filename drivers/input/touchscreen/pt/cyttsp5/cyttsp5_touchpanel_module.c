...
EXPORT_SYMBOL(cyttsp5_touchpanel_module_set_data);
...
EXPORT_SYMBOL(cyttsp5_touchpanel_module_clear_data);
...
EXPORT_SYMBOL(cyttsp5_touchpanel_module_update_panel_kind);
...
EXPORT_SYMBOL(cyttsp5_touchpanel_module_get_panel_kind);
...
EXPORT_SYMBOL(cyttsp5_touchpanel_module_init);

void cyttsp5_touchpanel_module_exit(void)
{
	return;
}
EXPORT_SYMBOL(cyttsp5_touchpanel_module_exit);
