...
//#define	CYTTSP5_DEVELOP_MODE_ENABLE

#define	MEMORY_COPY_CHECK_ENABLE

#define	CYPRESS_CYTTSP5_SYSFS_BINARY_FW_UPGRADE
#define	CYPRESS_CYTTSP5_SYSFS_CALIBRATE

#define CYPRESS_CYTTSP5_LPMODE_ENABLE
#define	CYPRESS_CYTTSP5_GLOVE_ENABLE
#define	CYPRESS_CYTTSP5_LPWG_ENABLE
#define	CYPRESS_CYTTSP5_ALWAYS_ON_DISPLAY_ENABLE
#define	CYPRESS_CYTTSP5_SEND_SHTERM_EVENT_ENABLE
#define	CYPRESS_CYTTSP5_CHARGER_ARMOR_ENABLE
#define	CYPRESS_CYTTSP5_PANEL_KIND_DETECT_ENABLE

#if defined(CYPRESS_CYTTSP5_GLOVE_ENABLE)
	#define CYPRESS_CYTTSP5_GLOVE_GRIP_ENABLE	1
	#define CYPRESS_CYTTSP5_GLOVE_GRIP_XEDG		1
#endif /* CYPRESS_CYTTSP5_GLOVE_ENABLE */

#if defined(CYPRESS_CYTTSP5_LPWG_ENABLE)
	#define CYPRESS_CYTTSP5_PROXIMITY_SUPPORT_ENABLE

	#if defined(CYPRESS_CYTTSP5_PROXIMITY_SUPPORT_ENABLE)
		#include <misc/proximity.h>
		#define CYPRESS_CYTTSP5_PROXIMITY_NEAR			SH_PROXIMITY_NEAR
		#define CYPRESS_CYTTSP5_PROXIMITY_FAR			SH_PROXIMITY_FAR
	#endif /* CYPRESS_CYTTSP5_PROXIMITY_SUPPORT_ENABLE */

	#define CYPRESS_CYTTSP5_LPWG_WAKE_LOCK_TIMEOUT_MS		2000
...
#define parade_debug(dev, dlevel, format, arg...)	 \
	do { \
		...
		if (cd_tmp->debug_level >= dlevel) {\
			dev_dbg(dev, "[%5d][%02X]"format, current->pid, cd_tmp->debug_level, ##arg);\
		} \
	} while (0)
...
struct cyttsp5_mt_data {
	...
	int t_max;
#if defined(CYPRESS_CYTTSP5_LPWG_ENABLE)
	struct cyttsp5_mt_lpwg_info lpwg;
#endif /* CYPRESS_CYTTSP5_LPWG_ENABLE */
};
...
#if 1
	struct delayed_work watchdog_timer;
#else
