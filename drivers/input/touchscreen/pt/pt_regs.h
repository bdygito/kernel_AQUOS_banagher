...
#define	PARADE_RECOVER_I2C_ERROR_ENABLE
#define	PARADE_PANEL_KIND_DETECT_ENABLE
...
/*============================================================================*/
	...
	PT_PARAM_DEF(PARADE_GLOVE_GRIP_ENABLE,	0)
	PT_PARAM_DEF(PARADE_GLOVE_GRIP_XEDG,	1)
...
//		{240,	0x03},
	...
	#define PARADE_RECOVER_I2C_ERROR_COUNT_MAX				5

	#define PARADE_RECOVER_I2C_ERROR_FLG_NORMAL				0
	#define PARADE_RECOVER_I2C_ERROR_FLG_RECOVERING			1
	#define PARADE_RECOVER_I2C_ERROR_FLG_RECOVER_ERROR		2
#endif /* PARADE_RECOVER_I2C_ERROR_ENABLE */

#if defined(PARADE_PANEL_KIND_DETECT_ENABLE)
	#define PARADE_SH_BOOT_TOUCHPANEL_KIND_TT7002		0
	#define PARADE_SH_BOOT_TOUCHPANEL_KIND_TT41701		1
	#define PARADE_SH_BOOT_TOUCHPANEL_KIND_FT3519		2
...
#endif /* PARADE_ASYNC_WAKE_ENABLE */
#if defined(PARADE_RECOVER_I2C_ERROR_ENABLE)
	int recover_i2c_error_flg;
	int recover_i2c_error_count;
	struct work_struct recover_i2c_error_work;
#endif /* PARADE_RECOVER_I2C_ERROR_ENABLE */
};
...
#ifdef CONFIG_DRM_PANEL
int pt_set_active_panel(struct drm_panel *panel);
#endif
