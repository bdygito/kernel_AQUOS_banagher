...
#ifdef SYNAPTICS_TCM_SEND_SHTERM_EVENT_ENABLE
	#include <misc/shterm_k.h>
#endif /* SYNAPTICS_TCM_SEND_SHTERM_EVENT_ENABLE */
...
#ifdef SYNAPTICS_TCM_SEND_SHTERM_EVENT_ENABLE
STORE_PROTOTYPE(reflash, battlog)
#endif /* SYNAPTICS_TCM_SEND_SHTERM_EVENT_ENABLE */
...
#ifdef SYNAPTICS_TCM_SEND_SHTERM_EVENT_ENABLE
static ssize_t reflash_sysfs_battlog_store(struct device *dev,
		struct device_attribute *attr, const char *buf, size_t count)
{
	int retval;
	unsigned int input;
