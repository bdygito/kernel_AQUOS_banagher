...
/* [ Config ]                                                                 */
/*============================================================================*/
//TODO	#define SYNAPTICS_TCM_SEND_SHTERM_EVENT_ENABLE

//TODO	#define SYNAPTICS_TCM_COVER_ENABLE
...
#define SYNAPTICS_TCM_POWER_CONTROL_ENABLE
#define SYNAPTICS_TCM_PANEL_CONNECT_CHECK_ENABLE

/*============================================================================*/
/* [ Parameters ]                                                             */
/*============================================================================*/
#define TOUCH_DEFAULT_MAX_X					1079
#define TOUCH_DEFAULT_MAX_Y					2339
...
int romboot_module_init(void);
void romboot_module_exit(void);
