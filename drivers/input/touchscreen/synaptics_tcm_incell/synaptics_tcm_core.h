...
#define SYNAPTICS_TCM_CHARGER_ARMOR_ENABLE

//#define SYNAPTICS_TCM_GET_PANEL_VENDOR_ENABLE

#define SYNAPTICS_TCM_AMBIENT_DISPLAY_ENABLE
#define SYNAPTICS_TCM_ALWAYS_ON_DISPLAY_ENABLE

#define SYNAPTICS_TCM_MODULE_VENDOR_DETECT_ENABLE

#define SYNAPTICS_TCM_DETECT_PANEL_ERROR_ENABLE

/*============================================================================*/
/* [ Parameters ]                                                             */
/*============================================================================*/
#define TOUCH_DEFAULT_MAX_X					1079
#define TOUCH_DEFAULT_MAX_Y					2279
#define TOUCH_DEFAULT_MAX_OBJEXTS			5

#if defined(SYNAPTICS_TCM_DETECT_PANEL_ERROR_ENABLE)
	#define SYNAPTICS_TCM_DETECT_PANEL_ERROR_MAX		10
#endif /* SYNAPTICS_TCM_DETECT_PANEL_ERROR_ENABLE */

#ifdef CONFIG_DRM_PANEL
	#define SYNAPTICS_TCM_PANEL_NOTIFIER_REGISTER_RETRY_MAX				10
	#define SYNAPTICS_TCM_PANEL_NOTIFIER_REGISTER_RETRY_INTERVAL_MS		1000
#endif
...
#define LOGx(func, dev, log, ...) \
	func(dev, "[%5d]%s: " log, current->pid, __func__, ##__VA_ARGS__)

#define LOGy(func, dev, log, ...) \
	func(dev, "[%5d]%s (line %d): " log, current->pid, __func__, __LINE__, ##__VA_ARGS__)
...
struct syna_tcm_hcd {
	...
	struct pinctrl_state *int_state_pullup;
...
static inline bool is_suspended(struct syna_tcm_hcd *tcm_hcd)
{
#if defined(SYNAPTICS_TCM_AMBIENT_DISPLAY_ENABLE)
	return (tcm_hcd->in_suspend || tcm_hcd->in_glance_mode);
#else
	return tcm_hcd->in_suspend;
#endif /* SYNAPTICS_TCM_AMBIENT_DISPLAY_ENABLE */
}
