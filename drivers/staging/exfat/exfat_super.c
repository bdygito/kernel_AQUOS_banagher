...
static void exfat_time_fat2unix(struct timespec64 *ts, struct date_time_t *tp, /*u8 time_cs,*/ u8 utc_offset)
{
    time64_t utc_offs;
...
static void exfat_time_unix2fat(struct timespec64 *ts, struct date_time_t *tp, /*u8 *time_cs,*/ u8 *utc_offset)
{
