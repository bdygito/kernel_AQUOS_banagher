...
struct fs_func {
	...
	void	(*set_entry_time)(struct dentry_t *p_entry,
				  struct timestamp_t *tp, u8 mode);
	u8	(*get_entry_create_utc_offset)(struct dentry_t *p_entry);
	void	(*set_entry_create_utc_offset)(struct dentry_t *p_entry, u8 utc_offset);
	u8	(*get_entry_modify_utc_offset)(struct dentry_t *p_entry);
	void	(*set_entry_modify_utc_offset)(struct dentry_t *p_entry, u8 utc_offset);
	u8	(*get_entry_access_utc_offset)(struct dentry_t *p_entry);
	void	(*set_entry_access_utc_offset)(struct dentry_t *p_entry, u8 utc_offset);
};
