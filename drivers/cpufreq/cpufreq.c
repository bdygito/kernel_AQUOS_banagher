...
struct drm_panel *sh_get_active_panel(void)
{
	return active_panel;
}
...
static const struct of_device_id sh_cpufreq_table[] = {
...
static struct platform_driver sh_cpufreq_driver = {
	...
	.driver = {
		.name = "sh_cpufreq",
		.of_match_table = sh_cpufreq_table,
	},
};
#endif /* CONFIG_SHARP_PNP_CLOCK */
...
#ifdef CONFIG_SHARP_PNP_CLOCK
	platform_driver_register(&sh_cpufreq_driver);
#endif /* CONFIG_SHARP_PNP_CLOCK */
