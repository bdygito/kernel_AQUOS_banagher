...
#elif defined(CONFIG_SHARP_TPS_FOCALTECH_FT3519)
	#define SHTPS_TM_TXNUM_MAX 34
...
#define TPSDEV_WAIT_ACTIVE _IO(TPS_IOC_MAGIC, 77)
#define TPSDEV_LPWG_SINGLE_TAP_ENABLE _IOW (TPS_IOC_MAGIC, 78, int)
#define TPSDEV_GET_SINGLE_TAP_ENABLE _IOR (TPS_IOC_MAGIC, 79, int)
#define TPSDEV_GET_RAW_SELF_DATA _IOR(TPS_IOC_MAGIC, 80, unsigned short *)
#define TPSDEV_GET_RAW_SELF_DATA_WP _IOR(TPS_IOC_MAGIC, 81, unsigned short *)
	...
	#define COMPAT_TPSDEV_GET_RAW_SELF_DATA _IOR(TPS_IOC_MAGIC, 80, shtps_ioctl_compat_pointer_param)
	#define COMPAT_TPSDEV_GET_RAW_SELF_DATA_WP _IOR(TPS_IOC_MAGIC, 81, shtps_ioctl_compat_pointer_param)
...
enum shtps_diag_tm_mode {
	...
	SHTPS_TMMODE_CBDATA,
	SHTPS_TMMODE_RAW_SELF_DATA,
	SHTPS_TMMODE_RAW_SELF_DATA_WP,
};
