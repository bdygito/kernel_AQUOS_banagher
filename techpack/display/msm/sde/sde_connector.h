...
struct sde_connector_ops {
	...
	int (*get_panel_vfp)(void *display, int h_active, int v_active, int clock);
#else
...
#ifdef CONFIG_SHARP_DISPLAY /* CUST_ID_00203 */
	void (*aod_disp_move)(void *display);
#endif /* CONFIG_SHARP_DISPLAY*/
#ifdef CONFIG_SHARP_DISPLAY /* CUST_ID_00210 */
	int (*update_dfps)(void *display);
#endif /* CONFIG_SHARP_DISPLAY*/
...
struct sde_connector {
	...
	bool hdr_capable;
#ifdef CONFIG_SHARP_DISPLAY /* CUST_ID_00203 */
	struct alarm aod_check_status_alarm;
	struct work_struct  aod_check_status_work;
	int aod_expire_cnt;
#endif /* CONFIG_SHARP_DISPLAY*/
};
