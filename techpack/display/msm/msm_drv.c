...
#ifdef CONFIG_SHARP_DISPLAY /* CUST_ID_00031 */ /* CUST_ID_01017 */
...
#endif /* CONFIG_SHARP_DISPLAY */
#ifdef CONFIG_SHARP_DISPLAY /* CUST_ID_00005 */ /* CUST_ID_00031 */
...
#ifdef CONFIG_SHARP_DISPLAY /* CUST_ID_00005 */
	ret = msm_drm_check_upper_unit(priv);
#endif /* CONFIG_SHARP_DISPLAY */
#ifdef CONFIG_SHARP_DISPLAY /* CUST_ID_00004 */
	if (ret == 0) {
...
#endif /* CONFIG_SHARP_DISPLAY */
#ifdef CONFIG_SHARP_DISPLAY /* CUST_ID_00028 */
	DRM_IOCTL_DEF_DRV(MIPI_DSI_CLKCHG,  msm_ioctl_mipi_dsi_clkchg,
			  DRM_UNLOCKED),
#endif /* CONFIG_SHARP_DISPLAY */
#ifdef CONFIG_SHARP_DISPLAY /* CUST_ID_01017 */
...
int msm_drm_check_upper_unit(struct msm_drm_private *priv)
{
	...
	if (sh_smem == NULL) {
		DRM_ERROR("get smem address is NULL\n");
		priv->upper_unit_is_connected = DRM_UPPER_UNIT_IS_NOT_CONNECTED;
		return -EINVAL;
	}
	...
	DRM_INFO("lcd_switch=%d\n", shdisp_boot_ctx->lcd_switch);
	return 0;
}
#endif /* CONFIG_SHARP_DISPLAY */
...
#ifdef CONFIG_SHARP_DISPLAY /* CUST_ID_00006 */
struct dsi_display *msm_drm_get_dsi_display(void)
{
	struct dsi_display *display = NULL;
...
{
	int ret_fps = msm_drv_fpslow_base;
#ifndef CONFIG_SHARP_DISPLAY_DMS_CUST
	ret_fps = 0;
...
#ifdef CONFIG_SHARP_DISPLAY /* CUST_ID_00037 */ /* CUST_ID_00210 */
static int msm_ioctl_set_flicker_param(struct drm_device *dev, void *data,
		struct drm_file *file)
{
	int ret = 0;
	...
	ret = drm_diag_set_flicker_param(display, param);
		...
		struct drm_file *file)
{
	...
	ret = drm_diag_get_flicker_param(display, param);

	return ret;
}
#endif /* CONFIG_SHARP_DISPLAY */

#ifdef CONFIG_SHARP_DISPLAY /* CUST_ID_00034 */ /* CUST_ID_00210 */
static int msm_ioctl_set_gmmtable_and_voltage(struct drm_device *dev,
		void *data, struct drm_file *file)
{
	int ret = 0;
	...
	ret = drm_diag_panel_set_gmm(display, gmm_volt_info);
	return ret;
}
		...
		void *data, struct drm_file *file)
{
	...
	ret = drm_diag_panel_get_gmm(display, gmm_volt_info);
	return ret;
}
#endif /* CONFIG_SHARP_DISPLAY */
