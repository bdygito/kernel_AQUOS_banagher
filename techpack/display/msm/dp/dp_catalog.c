...
static u8 vm_pre_emphasis_hbr3_hbr2[4 * 4] = {
	0x11, 0x0C, 0x15, 0x1A,
	0x02, 0x0E, 0x12, 0xFF,
	0x11, 0x11, 0xFF, 0xFF,
	0x04, 0xFF, 0xFF, 0xFF
...
static u8 vm_voltage_swing_hbr3_hbr2[4 * 4] = {
	0x1F, 0x12, 0x1C, 0x1F,
	0x09, 0x1E, 0x1F, 0xFF,
	0x1F, 0x1F, 0xFF, 0xFF,
	0x1F, 0xFF, 0xFF, 0xFF
...
static u8 vm_pre_emphasis_hbr_rbr[4 * 4] = {
	0x0F, 0x0B, 0x15, 0x1C,
	0x04, 0x10, 0x17, 0xFF,
	0x0F, 0x0F, 0xFF, 0xFF,
	0x01, 0xFF, 0xFF, 0xFF
...
static u8 vm_voltage_swing_hbr_rbr[4 * 4] = {
	0x1F, 0x0F, 0x16, 0x1F,
	0x11, 0x1E, 0x1F, 0xFF,
	0x1F, 0x1F, 0xFF, 0xFF,
	0x1F, 0xFF, 0xFF, 0xFF
...
module_param_array(vm_pre_emphasis_hbr3_hbr2, byte, NULL, 0644);
module_param_array(vm_voltage_swing_hbr3_hbr2, byte, NULL, 0644);
module_param_array(vm_pre_emphasis_hbr_rbr, byte, NULL, 0644);
module_param_array(vm_voltage_swing_hbr_rbr, byte, NULL, 0644);
		...
		u8 v_level, u8 p_level, bool high)
{
	...
	if (version == 0x10020004) {
		if (high) {
			value0 = vm_voltage_swing_hbr3_hbr2[v_level * 4 + p_level];
			value1 = vm_pre_emphasis_hbr3_hbr2[v_level * 4 + p_level];
		} else {
			value0 = vm_voltage_swing_hbr_rbr[v_level * 4 + p_level];
			value1 = vm_pre_emphasis_hbr_rbr[v_level * 4 + p_level];
		}
	} else {
		value0 = vm_voltage_swing[v_level * 4 + p_level];
		value1 = vm_pre_emphasis[v_level * 4 + p_level];
	}
#else
	if (version == 0x10020004) {
		if (high) {
