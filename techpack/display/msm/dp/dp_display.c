...
#ifdef CONFIG_SHARP_DISPLAY /* CUST_ID_00073 */
static void dp_display_init_wakelock(struct dp_display_private *dp)
{
	struct wake_lock * wakelock = &dp->wakelock;
	wake_lock_init(wakelock, &dp->pdev->dev, "dp_wakelock");
}

static void dp_display_destroy_wakelock(struct dp_display_private *dp)
{
	struct wake_lock * wakelock = &dp->wakelock;
	wake_lock_destroy(wakelock);
}

static void dp_display_set_wakelock(struct dp_display_private *dp, bool en)
{
	struct wake_lock * wakelock = &dp->wakelock;
...
static int dp_display_process_hpd_high(struct dp_display_private *dp)
{
	...
	dp_display_set_wakelock(dp, true);
#endif /* CONFIG_SHARP_DISPLAY */
...
static int dp_display_process_hpd_low(struct dp_display_private *dp)
{
	...
	dp_display_set_wakelock(dp, false);
#endif /* CONFIG_SHARP_DISPLAY */
...
{
#ifdef CONFIG_SHARP_DISPLAY /* CUST_ID_00073 */
	dp_display_destroy_wakelock(dp);
#endif /* CONFIG_SHARP_DISPLAY */
