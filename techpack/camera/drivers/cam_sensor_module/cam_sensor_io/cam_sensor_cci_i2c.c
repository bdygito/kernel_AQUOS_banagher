...
EXPORT_SYMBOL(cam_cci_i2c_read);
...
EXPORT_SYMBOL(cam_camera_cci_i2c_read_seq);
...
EXPORT_SYMBOL(cam_cci_i2c_write_table_cmd);
...
EXPORT_SYMBOL(cam_cci_i2c_write_table);
...
EXPORT_SYMBOL(cam_cci_i2c_write_continuous_table);
...
EXPORT_SYMBOL(cam_cci_i2c_compare);
...
EXPORT_SYMBOL(cam_cci_i2c_poll);
...
EXPORT_SYMBOL(cam_sensor_cci_i2c_util);
