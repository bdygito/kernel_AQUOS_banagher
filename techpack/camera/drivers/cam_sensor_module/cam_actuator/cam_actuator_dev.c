...
static const struct of_device_id cam_actuator_i2c_dt_match[] = {
	{ .compatible = ACTUATOR_DRIVER_I2C },
	{ }
};

MODULE_DEVICE_TABLE(of, cam_actuator_i2c_dt_match);
#endif /* KERNEL_SHLOCAL_KONA */
/* SHLOCAL_CAMERA_DRIVERS<- */
...
#ifdef KERNEL_SHLOCAL_KONA
		.owner = THIS_MODULE,
		.of_match_table = cam_actuator_i2c_dt_match,
#endif /* KERNEL_SHLOCAL_KONA */
/* SHLOCAL_CAMERA_DRIVERS<- */
	},
};
