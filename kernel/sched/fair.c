...
int sh_sched_load_boost_gold = 0;
int sh_sched_load_boost_gold_plus = 0;
unsigned int sh_sched_load_boost_freq_gold = 1958400;
unsigned int sh_sched_load_boost_freq_gold_plus = UINT_MAX;
#else /* CONFIG_ARCH_BANAGHER */
int sh_sched_load_boost_gold = -16;
int sh_sched_load_boost_gold_plus = 0;
unsigned int sh_sched_load_boost_freq_gold = 1401600;
unsigned int sh_sched_load_boost_freq_gold_plus = UINT_MAX;
